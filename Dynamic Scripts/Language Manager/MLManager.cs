...
namespace TahaGlobal.ML
{
    ...
    " editor, the language can still be changed in the play mode")]
        ...
        public void _SetTextMeta(ref TMP_Text iTMP)
        {
            iTMP.font = _currentFontMeta._fontAsset;
            iTMP.isRightToLeftText = _currentFontMeta._isRTL;
        }
        public void _SetTextMeta(ref Text iLegacyText)
        {
            iLegacyText.font = _currentFontMeta._font;
        }
        #endregion
